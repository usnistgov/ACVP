...
include::ml-kem/sections/05-ml-kem-encapsulation-capabilities.adoc[]

include::ml-kem/sections/05-ml-kem-decapsulation-capabilities.adoc[]
...
include::ml-kem/sections/06-ml-kem-encapsulation-test-vectors.adoc[]

include::ml-kem/sections/06-ml-kem-decapsulation-test-vectors.adoc[]

include::ml-kem/sections/07-responses.adoc[]

include::ml-kem/sections/07-ml-kem-keygen-responses.adoc[]

include::ml-kem/sections/07-ml-kem-encapsulation-responses.adoc[]

include::ml-kem/sections/07-ml-kem-decapsulation-responses.adoc[]
