...
| keyFormats | The ML-KEM key formats supported | array of strings | "expanded", "seed"
|===

Note: The `functions` and `keyFormats` properties are only applicable to ML-KEM / encapDecap / FIPS203-tr1. 
