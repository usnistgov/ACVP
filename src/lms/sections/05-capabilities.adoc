...
| messageLength | The message lengths supported by the implementation. | domain | Min: 8, Max: 65536, Increment: Any
|===
...
Note: The `messageLength` field is only applicable to LMS / sigGen / SP800-208, and LMS / sigVer / SP800-208. 
