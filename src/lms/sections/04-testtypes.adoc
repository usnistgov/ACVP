...
* Due to the randomized nature of generating LMS trees, the ACVP server *MAY* test implementations against the pseudorandom key generation process defined in <<RFC 8554>> Appendix A. 
