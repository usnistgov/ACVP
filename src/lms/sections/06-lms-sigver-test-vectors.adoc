...
The test group for LMS / sigVer / SP800-208 is as follows:
...
| messageLength | The bitlength of the message used to generate the signature | integer
| signature | THe signature to verify | hex
|===

The following is an example JSON object sent from the server to the client for LMS / sigVer / SP800-208.
