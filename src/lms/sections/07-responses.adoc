...
| tests | The test case objects in the response, depending on the algorithm see <<LMS_keyGen_vs_tr_table>>, <<LMS_sigGen_vs_tr_table>>, or <<LMS_sigVer_vs_tr_table>> | array
|===
