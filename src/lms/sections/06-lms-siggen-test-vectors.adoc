...
The test group for LMS / sigGen / SP800-208 is as follows:
...
| messageLength | The bitlength of the message to sign | integer
|===

The following is an example JSON object sent from the server to the client for LMS / sigGen / SP800-208.
