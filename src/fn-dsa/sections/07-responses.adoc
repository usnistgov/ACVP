...
| tests | The test case objects in the response, depending on the algorithm see <<FN-DSA_keyGen_vs_tr_table>>, <<FN-DSA_sigGen_vs_tr_table>>, or <<FN-DSA_sigVer_vs_tr_table>> | array
|===
