...
:title-main: ACVP KDA HKDF Specification
:title-main-short: ACVP KDA HKDF Specification
...
:spec-algorithm: KDA-HKDF SP800-56C
:algo-short-name: KDA-HKDF SP800-56C
...
include::kas/sp800-56c/hkdf/sections/03-supported.adoc[]

include::kas/sp800-56c/hkdf/sections/04-testtypes.adoc[]

include::common/common-sections/05-capabilities-description.adoc[]

include::common/common-sections/051-prerequisites.adoc[]

include::kas/sp800-56c/hkdf/sections/05-capabilities.adoc[]

include::common/common-sections/06-test-vector-intro.adoc[]

include::kas/sp800-56c/hkdf/sections/06-test-vectors.adoc[]

include::kas/sp800-56c/hkdf/sections/07-responses.adoc[]
...
include::kas/sp800-56c/hkdf/sections/98-references.adoc[]
