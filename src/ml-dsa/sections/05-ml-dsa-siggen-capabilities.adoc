...
Each ML-DSA / sigGen / FIPS204-tr1 algorithm capability advertised is a self-contained JSON object using the following values.
...
| revision | The algorithm testing revision to use | string | "FIPS204-tr1"
...
| keyFormats | The ML-DSA private key formats supported | array of strings | "expanded", "seed"
|===
...
Below is an example of the registration for ML-DSA / sigGen / FIPS204-tr1
