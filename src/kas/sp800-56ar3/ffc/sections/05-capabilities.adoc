...
| domainParameterGen| Array of IUT supported domain paameter generation methods.  Note that "FB" and "FC" are considered legacy, and should only be included for interoperability with othe systems unable to support the safe prime groups.| array | MODP-2048, MODP-3072, MODP-4096, MODP-6144, MODP-8192, ffdhe2048, ffdhe3072, ffdhe4096, ffdhe6144, ffdhe8192, FB, FC| No
|===
...
| fixedInfoPattern| The pattern used for fixedInfo construction. | string| See <<twostepkdf>>| No
